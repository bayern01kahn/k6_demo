...
export const options = {
  scenarios: {
    my_web_test: {
      ...
      tags: {
        test_type: 'website'
      }, // extra tags for the metrics generated by this scenario
    ...
    my_api_test_1: {
      ...
      tags: {
        test_type: 'api'
      }, // different extra metric tags for this scenario
      env: {
        MY_CROC_ID: '1'
      }, // and we can specify extra environment variables as well!
    ...
    my_api_test_2: {
      ...
      stages: [{
          target: 200,
          duration: '30s'
        }, // go from 50 to 200 iters/s in the first 30 seconds
        {
          target: 200,
          duration: '3m30s'
        }, // hold at 200 iters/s for 3.5 minutes
        {
          target: 0,
          duration: '30s'
        }, // ramp down back to 0 iters/s over the last 30 second
      ],
      ...
      env: {
        MY_CROC_ID: '2'
      }, // same function, different environment variables
